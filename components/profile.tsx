              ...
              <div className="mt-6 space-y-8 animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-base text-muted-foreground leading-relaxed pl-3 space-y-3">
                    ...
                    <p>
                      さらに中期的には、自身のキャリアパスとして、専門性を軸としたスペシャリスト、もしくはマネジメントの立場を目指し、組織の価値観や文化をメンバーへ浸透させ、前向きな変化を生むカルチャーを創る側になることを目標にしています。AI活用などを通じて業務改善に取り組み、現状維持にとどまらず、常により良い方向へ変化することを恐れない人材でありたいです。
                    </p>
                    <p>
