              ...
              <div className="mt-6 space-y-8 animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-base text-muted-foreground leading-relaxed pl-3 space-y-3">
                    ...
                    <p>
                      さらに中期的には、自身のキャリアパスとして、自身の強みを活かせるマネジメントの立場を目指し、組織の価値観や文化をメンバーへ浸透させ、前向きな変化を生むカルチャーを創る側になることを目標にしています。AIをはじめとする新しい技術を積極的に活用し、業務や開発プロセスの改善に取り組みたいです。効率化や自動化を推進するだけでなく、そこで生まれた余力を新しい挑戦やユーザー体験の向上に投資できるようにし、チームや組織により大きな価値をもたらすことを目指します。
                    </p>
                    <p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-base text-muted-foreground leading-relaxed pl-3 space-y-3">
                    ...
                    <p>
                      <strong>3つ目は、新しい技術や業務改善に積極的であることです。</strong>
